...
const ProductCard: React.FC<ProductCardProps> = (props) => {
  ...
  const handleInstantAdd = () => {
    ...
    const groupedAttributes: { [key: string]: any[] } =
      cartObject.attributes.reduce((acc: any, attr: any) => {
  ...
  return (
    <div
      ...
      onClick={cartObject.inStock ? handleViewDetails : handleViewDetails}
      className={`product-card p-3 ${
        !cartObject.inStock ? "out-of-stock" : ""
      }`}
    >
      <div className="container justify-content-center align-items-center">
        <div className="imageContainer">
          ...
          {cartObject.inStock && isHovered && (
            ...
            >
              <img className="instantBuyImage" src={instantBuyImageIcon} />
            </button>
          )}
        </div>
      ...
      <div>
        <h3 style={{ fontFamily: "Raleway", fontWeight: 300 }}>
          {cartObject.name}
        </h3>
